...
In this postdoc, I worked on 
  * [Building preconditioners for Variational **Data Assimilation** using **Machine Learning** (Preprint)](https://hal.science/hal-04707967)
  * Non-Linear Dimension reduction

* From October 2017 to July 2021, I was a PhD student in [AIRSEA](https://team.inria.fr/airsea/en/) (Inria
research team), working on the calibration of a regional model of the ocean under uncertainties.
...
### Repositories
* [moouu](https://gitlab.emse.fr/victor.trappler/moouu): Multiobjective Optimization under uncertainties using Bayesian Optimization (soon public)
* [eplus_wrapper](https://gitlab.limos.fr/miai-balteec/eplus_wrapper): Python wrapper and containerization of [EnergyPlus](https://energyplus.net/) for optimization and uncertainty quantification on buildings.

#### Not really maintained repos
* [robustGP](https://github.com/VTrappler/robustGP/tree/dev): Python package to construct and run Adaptive design methods based on Gaussian Processes for optimization under uncertainty
